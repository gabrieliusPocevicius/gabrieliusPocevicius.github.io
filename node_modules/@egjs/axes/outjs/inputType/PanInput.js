...
import { IS_IOS_SAFARI, IOS_EDGE_THRESHOLD, DIRECTION_NONE, DIRECTION_VERTICAL, DIRECTION_HORIZONTAL, DIRECTION_ALL, MOUSE_LEFT, } from "../const";
...
var PanInput = (function () {
    ...
    PanInput.prototype._onPanmove = function (event) {
        ...
        var offset = this._applyScale([panEvent.offsetX, panEvent.offsetY], [
    ...
    PanInput.prototype._applyScale = function (properties, direction) {
        var offset = [0, 0];
